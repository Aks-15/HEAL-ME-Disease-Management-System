	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-t-40 p-b-20">
				<form class="login100-form validate-form" action="../controller/dsignup.php" method="POST"enctype="multipart/form-data">
					...
					<div class="wrap-input100 validate-input m-t-85 m-b-35" data-validate = "Enter Username">
						<input class="input100" type="text" name="d_name" autocomplete="off"  pattern="^[A-Za-z\s]+$" title="Enter only characters" required>
					...
					<div class="wrap-input100 validate-input m-b-50" data-validate="Enter City">
						<input class="input100" type="text" name="d_adds" pattern="^[A-Za-z\s]+$" autocomplete="off" title="Enter only characters" required>
					...
					<div class="wrap-input100 validate-input m-b-50" data-validate="Enter Qualification">
						<input class="input100" type="varchar" name="d_qualfn" pattern="^[A-Za-z.,-]+$" autocomplete="off" title="Eg:M.B.B.S,MS-W,MD,DNB etc" required>
						<span class="focus-input100" data-placeholder="Qualification"></span>
					</div>

					<div class="wrap-input100 validate-input m-b-50" data-validate="Enter the Specialist in">
						<input class="input100" type="varchar" name="d_splist" pattern="^[A-Za-z-]+$" autocomplete="off" title="Eg:Gastrologist" required>
					...
					<div class="wrap-input100 validate-input m-b-50" data-validate="Enter Contact number">
						<input class="input100" type="varchar" name="d_phno" autocomplete="off" pattern="[0-9]{10}" title="Enter only the 10 digit number" required>
						<span class="focus-input100" data-placeholder="Phone number"></span>
					</div>

					<div class="wrap-input100 validate-input m-b-50" data-validate="Enter Clinic Name">
						<input class="input100" type="varchar" name="d_clnc" autocomplete="off" pattern="^[A-Za-z-]+$" title="Enter your Clinic or Hospital name" required>
					...
					<div class="wrap-input100 validate-input m-b-50" data-validate="Enter Clinic Location">
						<input class="input100" type="varchar" name="d_clncloc" autocomplete="off" pattern="^[A-Za-z,-]+$" title="Enter the location of your Clinic or Hospital" required>
					...
					<div class="wrap-input100 validate-input m-b-50" data-validate="Enter Email">
						<input class="input100" type="varchar" name="d_mail" autocomplete="off" pattern="[a-z0-9._%+-]+@[a-z.-]+\.[a-z]{2,4}$" title="xyz@something.com" required>
						<span class="focus-input100" data-placeholder="Email"></span>
					</div>

					<div class="wrap-input100 validate-input m-b-50" data-validate="Enter password">
						<input class="input100" type="password" name="d_pwd" autocomplete="off" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter with minimum of 8 characters" required>
