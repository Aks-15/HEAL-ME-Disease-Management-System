...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  ...
  <!-- 
		...
		<div class="container-fluid">
			...
			<table class="table table-responsive table-bordered" style="margin-top:-80px;">
					<thead>
						...
						<tbody id="example">
	<?php
	$stmt=$admin->ret("SELECT * FROM timing where did=".$d_id);
	while ($row=$stmt->fetch(PDO::FETCH_ASSOC)) {
		...
		';?>
		<td><a href="updateviewtiming.php?id=<?php echo $row['time_id']; ?>" style="margin-left:120px;" onclick="return confirm('Are you sure');" class="btn btn-danger">UPDATE</a></td>
