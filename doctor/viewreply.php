  ...
  <!-- 
		...
		<div class="container-fluid">
			<div class="row animate-box">
				<div class="col-md-6 col-md-offset-3 text-center qbootstrap-heading" style="margin-top:-80px;">
					<h2>Your Replies to the Patients</h2>
				</div>
			</div>
			<div class="row">
			<table class="table table-responsive table-bordered" style="margin-top:-80px;">
					<thead>
						...
						<tbody id="example">
	<?php
	$stmt=$admin->ret("SELECT * FROM `chat` INNER JOIN client on client.cl_id=chat.c_id WHERE chat.d_id=".$d_id);
	while ($row=$stmt->fetch(PDO::FETCH_ASSOC)) {
     ...
     <?php $st=$row['status'];
                        ...
                        {
                       ?>
                        <a href="sendreply.php?id=<?php echo $row['cl_id']; ?>&id1=<?php echo $row['box_id'];?>" class="btn btn-success">Request</a>
		...
		<!-- <td><a href="sendreply.php?id=<?php echo $row['cl_id']; ?>"><i class="icon-message"></i>Reply</a></td> -->
