...
$id1=$_GET['id1'];
$did=$_SESSION['did'];
$stmt=$admin->ret("SELECT * FROM `chat` WHERE c_id=".$id);
		...
		<div class="container">
			<div class="row animate-box">
				<div class="col-md-6 col-md-offset-3 text-center qbootstrap-heading" style="margin-top:-80px;">
					<h2>Give reply for the patient</h2>
				</div>
			</div>
			<div class="row">
				<div class="col-md-8 col-md-offset-2" style="margin-top:-70px;">
					<form action="../controller/sendreply.php" class="appointment-wrap animate-box" method="POST"enctype="multipart/form-data">
					
						<input type="hidden" name="cid" value="<?php echo $id;?>">
						<input type="hidden" name="bid" value="<?php echo $id1;?>">
						...
						<div class="row form-group">
							<div class="col-md-12">
								...
								<textarea name="rmsg" id="message" cols="30" rows="10" autocomplete="off" class="form-control" title="Enter the prescriptions for the tablets if sent" placeholder="Your Message" required></textarea>
							</div>
						</div>
						
						<div class="form-group">
							<input type="submit" value="Send" name="sendreply" class="btn btn-primary">
						</div>
