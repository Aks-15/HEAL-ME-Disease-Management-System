				...
				<div class="col-md-8 col-md-offset-2" style="margin-top:-70px;">
					<form action="../controller/sendnote.php" class="appointment-wrap animate-box" method="POST"enctype="multipart/form-data">
						...
						<div class="row form-group">
							<div class="col-md-12">
								<input type="hidden" name="did" class="form-control" value="<?php echo $did;?>">
								
							</div>
						</div>
					<div class="row form-group">
							<div class="col-md-12">
								<label for="email">Appointment cancelled patient</label>
								<input type="hidden" name="did" class="form-control" value="<?php echo $did;?>">
								<input type="hidden" name="cl_id" class="form-control" value="<?php echo $cl_id; ?>">

								<?php

									$stmt=$admin->ret("SELECT * from client INNER JOIN appointment on client.cl_id=appointment.cl_id WHERE appointment.cl_id=".$cl_id);
							...
							<div class="col-md-12">
								...
								<textarea name="note" id="message" cols="30" rows="10" title="Enter notification to the patient for the cancellation of an appointment and inform them about the next appointment date to book" class="form-control" autocomplete="off" placeholder="Your Message" required></textarea>
							</div>
						</div>
