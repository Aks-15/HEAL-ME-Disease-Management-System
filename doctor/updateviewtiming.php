...
$stmt=$admin->ret("SELECT * FROM `timing` WHERE time_id=".$id);
...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  ...
  <!-- 
	...
	<form action="../controller/updateviewtiming.php" method="POST">

							<div class="form-group">
							<br><label>Duration:</label><br>
							<label>From:</label>
								<input type="time" id="dur" name="from1" value="<?php echo $row['from1'];?>" class="form-control" placeholder="Enter the duration (Timing from)" required>
							<input type="hidden" name="id" value="<?php echo $row['time_id'];?>">
							...
							<label>To</label>
								<input type="time" id="dur" name="to1" value="<?php echo $row['to1'];?>" class="form-control" placeholder="Enter the duration (Timing to)" required>
							</div>
