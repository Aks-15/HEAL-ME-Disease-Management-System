...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  ...
  <!-- 
	...
	<br><h2 style="font-family:cursive;"><center>Patients details</center></h2><br>
	...
	while ($row=$stmt->fetch(PDO::FETCH_ASSOC)) {
		...
		<td><a href="Deletepatient.php?id=<?php echo $row['cl_id']; ?>" onclick="return confirm('Are you sure');" class="btn btn-danger">Delete</a></td>
						
		<!-- <td><a href="Updatepatient.php?id=<?php echo $row['cl_id']; ?>" class="btn btn-info">Update</a></td> -->
