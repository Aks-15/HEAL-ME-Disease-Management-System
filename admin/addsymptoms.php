...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  ...
  <!-- 
	...
	<br>
	<h3><div class="col-md-6" style="margin-left:150px;">SYMPTOM FORM</div></h3><br>
	<form action="../controller/addsymptoms.php" method="POST">
							...
							<textarea class="form-control" title="Enter only characters or its with numbers" placeholder="Enter the symptoms" name="symptoms" rows="3" required></textarea>
								<!-- <input type="text" id="symname" name="symname" class="form-control" placeholder="Enter the Symtoms"> -->
							</div>
																		
						<div class="form-group">
							<br><input type="submit" value="Submit" name="addsym" class="btn btn-primary">
						</div>
	</form>	
	</div>
	</div>
