...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  ...
  <!-- 
	...
	<br>
	<h3><div class="col-md-6" style="margin-left:150px;"></div></h3><br>
	<form action="" method="POST">

							<div class="form-group">
							<label>Current Password</label>
								<input type="text" id="disname" name="npwd" class="form-control" placeholder="Enter the Current Password">
							</div>


							<div class="form-group">
							<label>New Password</label>
								<input type="text" id="disname" name="cpwd" class="form-control" placeholder="Enter the New Password">
							</div>

							<div class="form-group">
							<label>Confirm </label>
								<input type="text" id="disname" name="cpwd" class="form-control" placeholder="Enter the Old Password">
							</div>
																		
						<div class="form-group">
							<br><input type="submit" value="Submit" name="chp" class="btn btn-primary">
						</div>
	</form>	
	</div>
	</div>
