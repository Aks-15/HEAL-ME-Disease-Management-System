...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  ...
  <!-- 
	...
	<br><h2 style="font-family:cursive;"><center>Appointment details</center></h2><br>
			<div class="row">
			<div class="container">
			...
			<table class="table table-responsive table-bordered" style="margin-bottom:100px;">
					<thead>
						...
						<tbody id="example">
	<?php
	$stmt=$admin->ret("SELECT * FROM appointment inner join doctors on appointment.d_id=doctors.d_id inner join client on appointment.cl_id=client.cl_id ");
