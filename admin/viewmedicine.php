...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  ...
  <!-- 
	...
	<div class="col-md-10 col-md-offset-1 animate-box">
					<br><h2 style="font-family:cursive;"><center>Medication details</center></h2><br>
					...
					<thead>
						...
						<tbody id="example">
	<?php
	$stmt=$admin->ret("SELECT * from disease INNER JOIN medicine ON disease.dis_id=medicine.dis_id");
	while ($row=$stmt->fetch(PDO::FETCH_ASSOC)) {
		...
		<td><a href="Deletemedication.php?id=<?php echo $row['med_id']; ?>" onclick="return confirm('Are you sure');"><i class="icon-trash"></i></a></td>
						
		<td><a href="Updatemedication.php?id=<?php echo $row['med_id']; ?>"><i class="icon-edit"></i></a></td>
