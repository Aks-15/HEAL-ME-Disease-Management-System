...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  ...
  <!-- 
	...
	<div class="col-md-10 col-md-offset-1 animate-box">
					<br><h2 style="font-family:cursive;"><center>Symptoms details</center></h2><br>
					...
					<thead>
						...
						<tbody id="example">
	<?php
	$stmt=$admin->ret("SELECT * from disease INNER JOIN symptom ON disease.dis_id=symptom.dis_id");
	while ($row=$stmt->fetch(PDO::FETCH_ASSOC)) {
		...
		<td><a href="Deletesymptoms.php?id=<?php echo $row['s_id']; ?>" onclick="return confirm('Are you sure');"><i class="icon-trash"></i></a></td>
						
		<td><a href="Updatesymtoms.php?id=<?php echo $row['s_id']; ?>"><i class="icon-edit"></i></a></td>
