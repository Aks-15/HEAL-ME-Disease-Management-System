...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  ...
  <!-- 
	...
	<form action="../controller/adddesease.php" method="POST">

							<div class="form-group">
							<label>Disease</label>
								<input type="text" id="disname" name="disname" autocomplete="off" class="form-control" placeholder="Enter the disease" pattern="^[A-Za-z0-9-]+$" title="Enter only characters or its with numbers" required>
							</div>
																		
						<div class="form-group">
							<br><input type="submit" value="Submit" name="adddisease" class="btn btn-primary">
						</div>
	</form>	
	</div>
	</div>
