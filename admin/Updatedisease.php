...
$stmt=$admin->ret("SELECT * FROM `disease` WHERE dis_id=".$id);
...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  ...
  <!-- 
	...
	<form action="../controller/updatedesease.php" method="POST">

							<div class="form-group">
							<label>Disease Name:</label>
								<input type="text" id="disname" name="disname" class="form-control" value="<?php echo $row['dis_name'];?>" autocomplete="off" placeholder="Enter the Disease" pattern="^[A-Za-z0-9-]+$" title="Enter only characters or its with numbers" required>
								<input type="hidden" name="id" value="<?php echo $row['dis_id'];?>">
							</div>
																		
						<div class="form-group">
							<br><input type="submit" value="Update" name="editisease" class="btn btn-primary">
						</div>
	</form>	
	</div>
	</div>
