...
$stmt=$admin->ret("SELECT * FROM `medicine` WHERE med_id=".$id);
...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  ...
  <!-- 
	...
	<br>
	<h3><div class="col-md-6" style="margin-left:150px;">MEDICINE FORM</div></h3><br>
	<form action="../controller/updatemedicine.php" method="POST">
							<div class="form-group">
						
							
							<input type="hidden" name="dis_id" class="form-control" value="<?php echo $row1['dis_id'];?>">
							...
							<label>Medication type:</label>
								<input type="text" id="medname" name="name" class="form-control" value="<?php echo $row1['name'];?>" placeholder="Enter the Medication type" autocomplete="off" pattern="^[A-Za-z0-9-,\s]+$" title="Enter only characters or its with numbers" required>
								<input type="hidden" name="id" value="<?php echo $row1['med_id'];?>">
							</div>
																		
						<div class="form-group">
							<br><input type="submit" value="Submit" name="editmed" class="btn btn-primary">
						</div>
	</form>	
	</div>
	</div>
