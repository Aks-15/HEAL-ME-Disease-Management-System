...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  ...
  <!-- 
	...
	<div class="col-md-10 col-md-offset-1 animate-box">
					<br><h2 style="font-family:cursive;"><center>Disease model</center></h2><br>
					...
					<thead>
						...
						<tbody id="example">
	<?php
	$stmt=$admin->ret("SELECT * FROM `symptom` INNER JOIN disease ON symptom.dis_id=disease.dis_id INNER JOIN medicine on disease.dis_id=medicine.dis_id");
