...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  ...
  <!-- 
	...
	<br><h2 style="font-family:cursive;"><center>Doctors details</center></h2><br>
	...
	<div class="col-md-10 col-md-offset-1 animate-box">
					...
					<thead>
						<tr>
							...
							<th style="text-align:center;">Clinic Location</th>
	...
	while ($row=$stmt->fetch(PDO::FETCH_ASSOC)) {
		...
		<td><a href="Deletedoctor.php?id=<?php echo $row['d_id']; ?>" onclick="return confirm('Are you sure');" class="btn btn-danger">Delete</a></td>
						
		<!-- <td><a href="Update.php?id=<?php echo $row['d_id']; ?>" class="btn btn-info">Update</a></td> -->
