		...
		<div class="container-fluid">
			<div class="row animate-box">
				<div class="col-md-6 col-md-offset-3 text-center qbootstrap-heading" style="margin-top:-70px;">
					<h2>Reason for the cancellation of an appointment</h2>
				</div>
			</div>
			<div class="row">
			<table class="table table-responsive table-bordered">
					<thead>
						<tr>
							...
							<th style="text-align:center;">Notified Date</th>
						...
						<tbody id="example">
	<?php
	$stmt=$admin->ret("SELECT * FROM notification inner join doctors on notification.d_id=doctors.d_id where notification.cl_id=".$cid);
