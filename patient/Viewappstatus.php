...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  ...
  <!-- 
		...
		<div class="container-fluid">
			<div class="row animate-box">
				<div class="col-md-6 col-md-offset-3 text-center qbootstrap-heading" style="margin-top:-70px;">
					<h2>Your appointment details with every doctors</h2>
				</div>
			</div>
			<div class="container">
			<div class="row">
	...
	// $apid=$_GET['aid'];
	// $d_id=$_GET['d_id'];
	$stmt=$admin->ret("SELECT * FROM appointment right join doctors on doctors.d_id=appointment.d_id WHERE appointment.cl_id=".$cid);
	while ($row=$stmt->fetch(PDO::FETCH_ASSOC)) {
     ...
     <?php $st=$row['Status'];
                      ...
                      <?php }else if($st=='Cancelled'){ ?>
                        ...
                        <a href="viewnote.php"><i class="icon-eye"></i>Viewnote</a>
                      <?php } 
                       else if($st=='Pending'){ ?>
