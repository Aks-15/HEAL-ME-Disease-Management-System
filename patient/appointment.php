		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-8 col-md-offset-2" style="margin-top:-70px;">
					<form action="../controller/appointment.php"  class="appointment-wrap animate-box"  method="POST">
						<div class="row form-group">
							<div class="col-md-6">
								<label for="fname">First Name</label>
								<input type="text" id="fname" name="name"value="<?php echo $row['name'];?>" class="form-control" placeholder="Your firstname">
						...
						<div class="row form-group">
							<div class="col-md-12">
								...
								<input type="text" id="email" class="form-control"value="<?php echo $row['email'];?>" placeholder="Your email address">
							</div>
						</div>
						...
						<div class="row form-group">
							<div class="col-md-12">
								...
								<input type="text" id="subject" class="form-control" value="<?php echo $row['ph_no'];?>" placeholder="Your Contact Number">
							</div>
						</div>
						...
						<div class="row form-group">
							<div class="col-md-12">
								...
								<input type="date" id="subject" class="form-control" name="date" placeholder="date" required>
							</div>
						</div>
						...
						<div class="row form-group">
							<div class="col-md-12">
								...
								<input type="time" id="subject" name="time" class="form-control" placeholder="time" required>
							</div>
						</div>
						...
						<div class="row form-group">
							<div class="col-md-12">
								...
								<textarea name="details" id="message" cols="30" rows="10" class="form-control" title="Enter the reason for an appointment" placeholder="Your Message" required></textarea>
							</div>
						</div>

						<div class="form-group">
							<input type="submit" value="Take appointment" name="appointment" class="btn btn-primary">
						</div>
