...
class Admin extends Main
{
	...
	{
		try{
			$stmnt=$this->conn->prepare("SELECT * from `admin` where a_uname= '$name' AND a_upwd='$password'");
			$stmnt->execute();
    ...
    public function loginClient($table,$name,$password)
	{
		try{
			$stmnt=$this->conn->prepare("SELECT * from `client` where name='$name' AND pwd='$password'");
			$stmnt->execute();
			$count=$stmnt->rowCount();
			$res=$stmnt->fetch(PDO::FETCH_ASSOC);
			//$id = $this->conn->lastInsertId();
			// $id = $res['id'];
			if($count){
				$_SESSION['cid']= $res['cl_id'];
				$_SESSION['client']= $res['name'];
				return true;
			}else{
				return false;
			}
    ...
    public function loginDoctor($table,$name,$password)
	{
		try{
			$stmnt=$this->conn->prepare("SELECT * from `doctors` where d_name='$name' AND d_pwd='$password'");
			$stmnt->execute();
			$count=$stmnt->rowCount();
			$res=$stmnt->fetch(PDO::FETCH_ASSOC);
			//$id = $this->conn->lastInsertId();
			// $id = $res['id'];
			if($count){
				$_SESSION['did']= $res['d_id'];
				$_SESSION['doctor']= $res['d_name'];
				return true;
			}else{
				return false;
			}
...
public function cud($res,$message){
	...
	public function show_value3($table,$field1,$field2,$field,$field3,$value1,$value2,$value3){
		 	try {
	...
	public function add_data10($table,$field1,$field2,$field3,$field4,$field5,$field6,$field7,$field8,$field9,$field10,$value1,$value2,$value3,$value4,$value5,$value6,$value7,$value8,$value9,$value10){
		try {
		     $stmt = $this->conn->prepare("INSERT INTO ".$table."(".$field1.",".$field2.",".$field3.",".$field4.",".$field5.",".$field6.",".$field7.",".$field8.",".$field9.",".$field10.") VALUES(:value1,:value2,:value3,:value4,:value5,:value6,:value7,:value8,:value9,:value10)");
		     $stmt->bindParam(':value1', $value1, PDO::PARAM_STR);
		         $stmt->bindParam(':value2', $value2, PDO::PARAM_STR);
		         $stmt->bindParam(':value3', $value3, PDO::PARAM_STR);
		        $stmt->bindParam(':value4', $value4, PDO::PARAM_STR);
		       ...
		       $stmt->bindParam(':value8', $value8, PDO::PARAM_STR);
		       $stmt->bindParam(':value9', $value9, PDO::PARAM_STR);
		        $stmt->bindParam(':value10', $value10, PDO::PARAM_STR);
	...
	public function add_data12($table,$field1,$field2,$field3,$field4,$field5,$field6,$field7,$field8,$field9,$field10,$field11,$field12,$value1,$value2,$value3,$value4,$value5,$value6,$value7,$value8,$value9,$value10,$value11,$value12){
		try {
		     $stmt = $this->conn->prepare("INSERT INTO ".$table."(".$field1.",".$field2.",".$field3.",".$field4.",".$field5.",".$field6.",".$field7.",".$field8.",".$field9.",".$field10.",".$field11.",".$field12.") VALUES(:value1,:value2,:value3,:value4,:value5,:value6,:value7,:value8,:value9,:value10,:value11,:value12)");
		     $stmt->bindParam(':value1', $value1, PDO::PARAM_STR);
		         $stmt->bindParam(':value2', $value2, PDO::PARAM_STR);
		         $stmt->bindParam(':value3', $value3, PDO::PARAM_STR);
		        $stmt->bindParam(':value4', $value4, PDO::PARAM_STR);
		       ...
		       $stmt->bindParam(':value9', $value9, PDO::PARAM_STR);
		        $stmt->bindParam(':value10', $value10, PDO::PARAM_STR);
		        $stmt->bindParam(':value11', $value9, PDO::PARAM_STR);
		        $stmt->bindParam(':value12', $value10, PDO::PARAM_STR);
	...
	//update 5 columns
	public function edit_data5($table,$field1,$field2,$field3,$field4,$field5,$value1,$value2,$value3,$value4,$value5,$fieldid,$id){
		try {
			$stmt = $this->conn->prepare("UPDATE ".$table." SET ".$field1."=:value1,".$field2."=:value2,".$field3."=:value3,".$field4."=:value4,".$field5."=:value5 where ".$id."=:id");
